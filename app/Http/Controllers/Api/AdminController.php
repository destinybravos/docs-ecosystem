...
class AdminController extends Controller
{
    ...
    public function delete_faculty(Request $request)
    {
        ...
        foreach ($faculty->departments as $key => $department) {
            foreach ($department->users as $key => $user) {
                $user->access_requests()->delete();
                $user->delete();
            }
            $department->delete();
        }
        $faculty->delete();
        return $this->sendResponse("Faculties delete successfully.", [
            'status' =>true,
        ]);
    }
    ...
    public function deleteDepartment(Request $request){
        ...
        $department->delete();
        return $this->sendResponse('Departments successfully deleted', []);
    }
